...
const baseline = await coherentBot.run({
  ...
  phases: [
    ...
    'analyze',     // → Verified + Insights
    'write'        // → Expert Report
  ]
})

console.log('Layers:', expert.comparison)`,
  },
];
      ...
      <div className="relative z-10 max-w-350 mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three layers.
            <br />
            <span className="text-background/50">Exponential depth.</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              <div className="px-6 py-4 border-b border-background/10 flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-background/40">research.ts</span>
              </div>
