...
const metrics = [
  { value: 7, suffix: "", prefix: "", label: "Quality dimensions scored per report" },
  { value: 60, suffix: "+", prefix: "", label: "Competitor sources auto-filtered" },
  { value: 3, suffix: "", prefix: "", label: "Parallel research layers" },
  { value: 5, suffix: "", prefix: "", label: "Expert pipeline phases per research" },
];
