...
from models.pipeline import Source, AgentContext, EvidenceLedger, ClaimMap
from utils.cost_tracker import track
from utils import infer_publisher, format_tier
...
def make_tools(ctx: AgentContext, ledger: EvidenceLedger | None = None, claim_map: ClaimMap | None = None) -> list:
    ...
    async def search_web(query: str) -> str:
        ...
        if ledger is not None:
            from models.pipeline import Evidence
            for r in results:
